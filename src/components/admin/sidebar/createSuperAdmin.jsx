...
class CreateSuperAdmin extends Component {
    ...
    newSuperAdmin =() =>{
        ...
        fetch(`https://cors-anywhere.herokuapp.com/http://ec2-3-20-203-149.us-east-2.compute.amazonaws.com/user/create`,
        {
        method:"POST",
        headers:{
    ...
    render() { 
        ...
        //message.hide();
          ...
          <div className="footer">
            <button type="button " className="btn btn-primary" onClick={()=> this.newSuperAdmin()}>
              Create 
            </button>
          </div>
